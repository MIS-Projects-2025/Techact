    ...
    <AuthenticatedLayout>
      ...
      <div className="p-6">
        ...
        <DataTable
          ...
          routeName={route("tech.doneActivities")}
  ...
  <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
    <div className="bg-white p-6 rounded shadow-lg w-1/3">
      ...
      <form
        onSubmit={(e) => {
          ...
          router.put(`/techact/forApproval/approve/${selectedActivity.id}`, {
            approver_id: form.emp_id,      // 👈 galing session
            approver_name: form.emp_name,  // 👈 galing session
            approve_date: new Date().toISOString(), // auto timestamp
            my_activity: selectedActivity.my_activity,
            machine: selectedActivity.machine,
            note: selectedActivity.note,
            remarks: selectedActivity.remarks,  // ✅ idagdag ito
            status: "Complete",
          }, {
            onSuccess: () => {
      ...
      >
        ...
        {/* ✅ Approver details (kung approved na) */}
